...
for the candidates file under --data-dir.
  ...
  --execute         applies operator-field corrections using --data-dir's saved candidates
...
Usage:
    ...
    sync_operators.py --rptsched-dir D --report
"""
import argparse
import io
import sys
...
def _run_detect(args, candidates_path):
    ...
    with redirect_stdout(buf):
        exit_code = detect_operators.main(["--rptsched-dir", str(args.rptsched_dir)])
    if exit_code != 0:
        return exit_code
